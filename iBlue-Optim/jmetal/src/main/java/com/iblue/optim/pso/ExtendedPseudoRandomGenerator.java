...
/**
 * Extended pseudo random number generator based on the decorator pattern. Two
 * new methods are added: randNormal() and randSphere()
 *
...
public class ExtendedPseudoRandomGenerator implements PseudoRandomGenerator {
	...
	/**
	 * Use the polar form of the Box-Muller transformation to obtain a pseudo random
	 * number from a Gaussian distribution Code taken from Maurice Clerc's
	 * implementation
	 *
	 * @param mean
	...
	/**
	 * Get a random point from an hypersphere (center = 0, radius = 1) Code taken
	 * from Maurice Clerc's implementation
	 *
	 * @param dimension
	...
	/**
	 * Ger a random point from an hypersphere Code taken from Maurice Clerc's
	 * implementation
	 *
	 * @param center
	 * @param radius
