...
public class Street implements StreetInterface {
	...
	public void setLatLong1(BigDecimal latitude1, BigDecimal longitude1) {
		this.latitude1 = latitude1.setScale(LAT_LON_SCALE, BigDecimal.ROUND_HALF_DOWN);
		this.longitude1 = longitude1.setScale(LAT_LON_SCALE, BigDecimal.ROUND_HALF_DOWN);
		setUTM1();
		setLineCoeff();
	}
	...
	public void setLatLong2(BigDecimal latitude2, BigDecimal longitude2) {
		this.latitude2 = latitude2.setScale(LAT_LON_SCALE, BigDecimal.ROUND_HALF_DOWN);
		this.longitude2 = longitude2.setScale(LAT_LON_SCALE, BigDecimal.ROUND_HALF_DOWN);
		setUTM2();
		setLineCoeff();
	}
