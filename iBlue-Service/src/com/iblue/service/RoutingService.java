...
public class RoutingService {
	...
	private LinkedList<WeightedStreet> getRouteDijkstra(float latitude1, float longitude1, float latitude2,
		...
		DijkstraAlgorithm dij = new DijkstraAlgorithm(map);
		dij.executeSource(stOrig.getFromIntersection());
		@SuppressWarnings("unchecked")
		LinkedList<WeightedStreet> streets = (LinkedList<WeightedStreet>) dij.getPath(stDest.getToIntersection());
